...
<div class="min-h-screen flex items-center justify-center px-4 py-10 bg-[#f3f4f6]">
    <div class="relative w-full max-w-md">
        ...
        {{-- Card --}}
        <div class="mt-8 w-full bg-white rounded-xl shadow-lg border border-gray-200 px-8 py-8">
            <form action="{{ route('login.post') }}" method="post" class="space-y-4">
                ...
                <button
                    type="submit"
                    class="mt-2 w-full py-2.5 rounded-md bg-slate-900 text-white text-sm font-semibold tracking-wide shadow-md hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-900 focus:ring-offset-[#f3f4f6]"
                >
                    LOGIN
                </button>
            </form>
