    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <form action="{{ route('dashboard.exam-calendar.store') }}" method="post" class="exam-calendar-form space-y-6">
            ...
            <div>
                ...
                <input type="text" name="course_name" id="course_name" value="{{ old('course_name') }}" required maxlength="255" placeholder="e.g. Introduction to Programming" class="form-input">
            </div>
            <div>
                <label for="lecturer" class="block text-sm font-medium text-gray-700 mb-1.5">Lecturer (optional)</label>
                <input type="text" name="lecturer" id="lecturer" value="{{ old('lecturer') }}" maxlength="255" placeholder="e.g. Dr. Jane Smith" class="form-input">
            </div>
